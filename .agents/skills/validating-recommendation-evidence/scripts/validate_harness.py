...
AGENTS = {
    "location-data-auditor": "gpt-5.6-luna",
    "location-input-contract-builder": "gpt-5.6-terra",
    "candidate-method-designer": "gpt-5.6-sol",
    "rag-evidence-builder": "gpt-5.6-terra",
    "recommendation-qa-reviewer": "gpt-5.6-sol",
}
